...
<html lang = "en">
    <head>
        ...
        <title>Photo de profil | Bibliothèque</title>
    </head>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title">Photo de profil</h4>
                                </div>
                            </div>
                        </div>
                        <div class = "row">
                                ...
                                <div class = "card">
                                    <div class = "card-body">
                                        ...
                                        <p class = "text-muted font-14">
                                            Changez la photo de profil en ajoutant une nouvelle image. Vous devez être sûr que l'image ajoutée est votre vraie photo car elle sera affichée dans votre profil.
                                        </p>
                                        ...
                                        @endif
                                        <form name = "photo-profil-form" id = "photo-profil-form" method = "post" action = "{{url('/modifier-photo-profil')}}" enctype = 'multipart/form-data'>
                                            @csrf
                                            <div class = "row">
                                                <div class = "col-md-12">
                                                    <div class = "mb-3">
