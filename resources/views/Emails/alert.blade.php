...
<html lang = "en">
    <head>
        ...
        <title>Alert | Université Sesame</title>
    </head>
                    ...
                    <div style = "-webkit-box-flex: 1; -ms-flex: 1 1 auto; flex: 1 1 auto; padding: 1.5rem 1.5rem;">
                        <div style = "margin: -1.5rem 0 -1.5rem 250px; padding: 1.5rem 0 1.5rem 25px;">
                            <div style = "margin-top: 1.5rem !important;">
                                <p style = "margin-top: 0; margin-bottom: 1rem;">Bonjour {{$mailData['fullname']}}, </p>
                                <p style = "margin-top: 0; margin-bottom: 1rem;">
                                    Veuillez régler votre situation concernant les livres à mettre à la bibliothèque. Vous avez un livre intitulé <b>{{$mailData['titre']}}</b> a été réservé le <?php setlocale (LC_TIME, 'fr_FR.utf8','fra'); echo utf8_encode(strftime("%A %d %B %Y",strtotime(strftime($mailData['date_pret']))));?>.
                                    <br>
