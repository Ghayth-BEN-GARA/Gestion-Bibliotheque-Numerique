...
<html lang = "en">
    <head>
        ...
        <title>Récupération | IPSAS</title>
    </head>
                    ...
                    <div style = "-webkit-box-flex: 1; -ms-flex: 1 1 auto; flex: 1 1 auto; padding: 1.5rem 1.5rem;">
                        <div style = "margin: -1.5rem 0 -1.5rem 250px; padding: 1.5rem 0 1.5rem 25px;">
                            <div style = "margin-top: 1.5rem !important;">
                                <p style = "margin-top: 0; margin-bottom: 1rem;">Bonjour IPSAS, </p>
                                <p style = "margin-top: 0; margin-bottom: 1rem;">
                                    Un utilisateur nommé <b>{{$mailData['fullname']}}</b> vous a envoyé un email à propos la réservation d'un livre. L'email contient comme informations :
                                    <ul>
                                        <li>
                                            <b> Nom : </b> {{$mailData['fullname']}}
                                        </li>
                                        <li>
                                            <b> Email : </b> {{$mailData['email']}}
                                        </li>
                                        <li>
                                            <b> Livre : </b> {{$mailData['titre']}}
                                        </li>
                                        <li>
                                            <b> Auteur : </b> {{$mailData['auteur']}}
                                        </li>
                                        <li>
                                            <b> Date de réservation : </b> <?php setlocale (LC_TIME, 'fr_FR.utf8','fra'); echo utf8_encode(strftime("%A %d %B %Y",strtotime(strftime($mailData['date_pret']))));?>
                                        </li>
                                    </ul>
                                </p>
