                                            ...
                                            <div class = "row">
                                                <div class = "col-lg-5">
                                                    <a href = "javascript: void(0)" class = "text-center d-block mb-4">
                                                        <img src = "{{URL::asset($livre->getImageLivreAttribute())}}" class = "img-fluid" style = "max-width: 280px;" alt = "Image de livre">
                                                    </a>
                                                </div>
                                                <div class = "col-lg-7">
                                                    <form class = "ps-lg-4">
                                                        <h3 class = "mt-0">
                                                            {{$livre->getTitreLivreAttribute()}} 
                                                        </h3>
                                                        ...
                                                        <div class = "mt-3">
                                                            <h4>
                                                                Auteur : {{$livre->getAuteurLivreAttribute()}}
                                                            </h4>
                                                        </div>
                                                        <div class = "mt-4">
                                                            <h6 class = "font-14">Identifiant :</h6>
                                                            <h3>{{$livre->getIdLivreAttribute()}}</h3>
                                                        </div>
                                                        <div class = "mt-4">
                                                            <h6 class = "font-14">Description :</h6>
                                                            <p>{{$livre->getDescriptionLivreAttribute()}}</p>
                                                        </div>
                                                    </form>
                                                </div>
                                                <form name = "creer-reservation-form" id = "creer-reservation-form" method = "post" action = "{{url('/creer-reservation')}}">
                                                    @csrf
                                                    <div class = "row">
                                                        <div class = "col-md-6">
                                                            <div class = "mb-3">
